...
import { singleBlogList } from '../../auth/adminapi';
...
const BlogEdit = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            const data = await singleBlogList(id);
            console.log(data);
            setData(data)
        }
        fetchData()
