...
const TourTestimonial = () => {
  return (
    <Wrapper>
      <section style={{ backgroundColor: "#0f2454" }}>
        <div class="mx-auto max-w-screen-4xl px-4 py-10 sm:px-6 sm:py-24 lg:px-8">
          <div class="mx-auto max-w-4xl text-center">
            <h2 class="text-6xl font-bold sm:text-5xl text-white">
              Read trusted reviews from our customers
            </h2>

            <p class="text-gring-offset-warm-gray-500 mx-auto mt-4 max-w-5xl text-white text-2xl">
          ...
          <div class="mt-16 grid grid-cols-1 gap-8 sm:grid-cols-2 sm:gap-16 lg:grid-cols-3">
            <div>
              ...
              <blockquote class="-mt-6 flex flex-col justify-between rounded-lg p-12 text-center shadow-xl bg-white">
                <p class="text-3xl font-bold text-gray-700">Sophie Lennon</p>
                <p class="mt-1 text-lg bold text-gray-500">
