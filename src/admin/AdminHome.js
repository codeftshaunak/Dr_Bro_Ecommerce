...
import AdminPassportEdit from './AdminPassportEdit';
// import AdminLayout from './AdminLayout';
        ...
        <AdminLayout>
            <div>
                ...
                {showEditForm && selectedApplication && (
                    // <div className=" align-bottom flex mx-auto my-auto w-24 left-50% justify-center items-center bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
